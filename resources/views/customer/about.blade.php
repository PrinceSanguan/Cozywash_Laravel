...
<link rel="stylesheet" href="{{asset('css/login_about.css')}}">
<script src="{{asset('css/login_about.js')}}"></script>
...
<!--Container 1 & 2 About Us-->
    <div class="container1">
            ...
            <img src="{{asset('image/about.png')}}" style="width:800px;" "height: 500px;">
